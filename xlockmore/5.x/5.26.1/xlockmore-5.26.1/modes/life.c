...
static OptionStruct desc[] =
{
	...
	{(char *) "-repeat num", (char *) "repeat for period to exclude in search"},
...
static void
print_list(lifestruct * lp, int i)
{
	...
	if ((glidersearch || patternsearch) && tcount[0] < 72) {
		...
		if (i == 1 && (tcount[0] <= 64 || tcount[1] <= 64) &&
				(tcount[0] != tcount[1] || 
...
init_life(ModeInfo * mi)
{
	...
	if (MI_IS_FULLRANDOM(mi)) {
...
#if 1
		lp->neighbors = (NRAND(r8n2 + r6n2 + r12n2) < r8n2) ? 8 :
			(NRAND(r6n2 + r12n2) < r6n2) ? 6 : 12;
#else
		lp->neighbors = 8;
#endif
		if  (lp->neighbors == 8) {
		...
		if  (lp->neighbors == 6) {
			...
			lp->highlife = (n >= patterns_6rules[0] && n < r6n1);
			lp->bays = (n >= r6n1);
		} else {
