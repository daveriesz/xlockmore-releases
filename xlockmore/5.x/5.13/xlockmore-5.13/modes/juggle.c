 ...
 *
 * Revision History
 * 02-Sep-2003: Non-real time to see what is happening without a strobe effect
 *              for slow machines.
...
static XrmOptionDescRec opts[] =
{
  ...
  {(char* ) "-tail", (char *) ".juggle.tail",
   XrmoptionSepArg, (caddr_t) NULL},
#ifdef UNI
  {(char *) "-uni", (char *) ".juggle.uni", XrmoptionNoArg, (caddr_t) "on"},
  {(char *) "+uni", (char *) ".juggle.uni", XrmoptionNoArg, (caddr_t) "off"},
#endif
  {(char *) "-real", (char *) ".juggle.real", XrmoptionNoArg, (caddr_t) "on"},
  {(char *) "+real", (char *) ".juggle.real", XrmoptionNoArg, (caddr_t) "off"},
...
static argtype vars[] =
{
  ...
  {(caddr_t *) &tail, (char *) "tail",
   (char *) "Tail", (char *) DEF_TAIL, t_Int},
#ifdef UNI
  {(caddr_t *) &uni, (char *) "uni",
   (char *) "Uni", (char *) DEF_UNI, t_Bool},
#endif
  {(caddr_t *) &real, (char *) "real",
   (char *) "Real", (char *) DEF_REAL, t_Bool},
...
static OptionStruct desc[] =
{
  ...
  {(char *) "-tail num", (char *) "Trace Juggling Patterns"},
#ifdef UNI
  {(char *) "-/+uni", (char *) "Unicycle"},
#endif
  {(char *) "-/+real", (char *) "Real-time"},
...
static patternstruct portfolio[] = {
  ...
  {(char *) "[+4 x4 =4]", (char *) "+4 x4 =4, Mill's mess for 4"},
...
init_juggle(ModeInfo * mi)
{
	...
	if (sp->trace == NULL) {
	  if ((sp->trace = (XPoint *)calloc(tail, sizeof(XPoint))) == NULL) {
		free_juggle(sp);
 		return;
	  }
	}
