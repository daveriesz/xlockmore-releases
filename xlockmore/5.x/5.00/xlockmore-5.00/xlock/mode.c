...
LockStruct  LockProcs[] =
{
	...
	{(char *) "pentominoes", init_pentominoes, draw_pentominoes, release_pentominoes,
        refresh_pentominoes, init_pentominoes, NULL, &pentominoes_opts,
        1000, 1024, 3000, 1, 64, 1.0, (char *) "",
        (char *) "Shows attempts to place pentominoes into a rectangle", 0, NULL},
#endif
#ifdef MODE_petal
