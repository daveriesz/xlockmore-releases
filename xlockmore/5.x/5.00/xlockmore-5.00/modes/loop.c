...
static const char sccsid[] = "@(#)loop.c	5.00 2000/11/01 xlockmore";
 ...
 *              as a guide, hexagon have more neighbors so there is more
 *              freedom to program, and the loop will has six sides to
 *              store its genes (data).
 *              (Soon after this a triangular version with neighbors = 6 but
 *              was unsuccessful).
...
/*-
   ...
   least to me): Is handedness a requirement for life?  Here there is
   handedness at both the initial condition and the transition rule.
 */
