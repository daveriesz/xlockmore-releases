...
#include "brick1_png.h"
#include "brick2_png.h"
#include "wood2_png.h"
#include "start_png.h"
#include "bob_png.h"
#include "logo-32_png.h"

#ifdef USE_FLOATING_IMAGES
# include "opengltxt_png.h"
# include "openglbook_png.h"
#endif
#ifdef USE_FRACTAL_IMAGES
# include "fractal1_png.h"
# include "fractal2_png.h"
# include "fractal3_png.h"
# include "fractal4_png.h"
#endif
...
ENTRYPOINT void
release_maze3d (ModeInfo * mi)
{
   if (mazes != NULL) {
      int screen;

      for (screen = 0; screen < MI_NUM_SCREENS(mi); screen++) {
	maze_configuration *maze = &mazes[screen];
