		...
		Bool use, Bool all)
{
	...
	if (size == 4) {
		...
		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 1) && fd.depth == 0)
			...
			drawOctaFacet(mi, 1, 3, -1, -1, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 1 || fd.face == 2) && fd.depth == 0)
			...
			drawOctaFacet(mi, -1, 1, 3, -1, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 2 || fd.face == 3) && fd.depth == 0)
			...
			glPushMatrix();
			glTranslate(-s2 * FACET_LENGTH, s0 * FACET_LENGTH, 0);
			drawOctaFacet(mi, -1, -1, 1, 3, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 3) && fd.depth == 0)
			...
			glPushMatrix();
			glTranslate(0, s0 * FACET_LENGTH, -s2 * FACET_LENGTH);
			drawOctaFacet(mi, 3, -1, -1, 1, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 3) && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(0, -s0 * FACET_LENGTH, s2 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, -1, -1, 1, 3, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 2 || fd.face == 3) && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(s2 * FACET_LENGTH, -s0 * FACET_LENGTH, 0);
			drawOctaFacet(mi, -1, -1, -1, -1, -1, 1, 3, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 1 || fd.face == 2) && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(0, -s0 * FACET_LENGTH, -s2 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, -1, -1, -1, -1, 1, 3);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 1) && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(-s2 * FACET_LENGTH, -s0 * FACET_LENGTH, 0);
			drawOctaFacet(mi, -1, -1, -1, -1, 3, -1, -1, 1);
			glPopMatrix();
		}

		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 1) && fd.depth == 0)
				|| (use && (fd.face == 2 || fd.face == 3) && fd.depth == 2)
				|| (!use && (fd.face == 0 || fd.face == 1) && fd.depth != 0)
				|| (!use && (fd.face == 2 || fd.face == 3) && fd.depth != 2)))
			|| (sticky && ((use && (fd.face == 0 || fd.face == 1) && fd.depth == 0)
				|| (use && (fd.face == 2 || fd.face == 3) && (fd.depth == 1 || fd.depth == 2))
			...
			drawOctaFacet(mi, 4, 8, -1, -1, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 1 || fd.face == 2) && fd.depth == 0)
				|| (use && (fd.face == 0 || fd.face == 3) && fd.depth == 2)
				|| (!use && (fd.face == 1 || fd.face == 2) && fd.depth != 0)
				|| (!use && (fd.face == 0 || fd.face == 3) && fd.depth != 2)))
			|| (sticky && ((use && (fd.face == 1 || fd.face == 2) && fd.depth == 0)
				|| (use && (fd.face == 0 || fd.face == 3) && (fd.depth == 1 || fd.depth == 2))
			...
			drawOctaFacet(mi, -1, 4, 8, -1, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 2 || fd.face == 3) && fd.depth == 0)
				|| (use && (fd.face == 0 || fd.face == 1) && fd.depth == 2)
				|| (!use && (fd.face == 2 || fd.face == 3) && fd.depth != 0)
				|| (!use && (fd.face == 0 || fd.face == 1) && fd.depth != 2)))
			|| (sticky && ((use && (fd.face == 2 || fd.face == 3) && fd.depth == 0)
				|| (use && (fd.face == 0 || fd.face == 1) && (fd.depth == 1 || fd.depth == 2))
			...
			glPushMatrix();
			glTranslate(-s0 * FACET_LENGTH, s2 * FACET_LENGTH, 0);
			drawOctaFacet(mi, -1, -1, 4, 8, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 3) && fd.depth == 0)
				|| (use && (fd.face == 1 || fd.face == 2) && fd.depth == 2)
				|| (!use && (fd.face == 0 || fd.face == 3) && fd.depth != 0)
				|| (!use && (fd.face == 1 || fd.face == 2) && fd.depth != 2)))
			|| (sticky && ((use && (fd.face == 0 || fd.face == 3) && fd.depth == 0)
				|| (use && (fd.face == 1 || fd.face == 2) && (fd.depth == 1 || fd.depth == 2))
			...
			glPushMatrix();
			glTranslate(0, s2 * FACET_LENGTH, -s0 * FACET_LENGTH);
			drawOctaFacet(mi, 8, -1, -1, 4, -1, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 3) && fd.depth == size - 1)
				|| (use && (fd.face == 1 || fd.face == 2) && fd.depth == size - 3)
				|| (!use && (fd.face == 0 || fd.face == 3) && fd.depth != size - 1)
				|| (!use && (fd.face == 1 || fd.face == 2) && fd.depth != size - 3)))
			|| (sticky && ((use && (fd.face == 0 || fd.face == 3) && fd.depth == size - 1)
				|| (use && (fd.face == 1 || fd.face == 2) && (fd.depth == 1 || fd.depth == 2))
			...
			glPushMatrix();
			glTranslate(0, -s2 * FACET_LENGTH, s0 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, -1, -1, 4, 8, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 2 || fd.face == 3) && fd.depth == size - 1)
				|| (use && (fd.face == 0 || fd.face == 1) && fd.depth == size - 3)
				|| (!use && (fd.face == 2 || fd.face == 3) && fd.depth != size - 1)
				|| (!use && (fd.face == 0 || fd.face == 1) && fd.depth != size - 3)))
			|| (sticky && ((use && (fd.face == 2 || fd.face == 3) && fd.depth == size - 1)
				|| (use && (fd.face == 0 || fd.face == 1) && (fd.depth == 1 || fd.depth == 2))
			...
			glPushMatrix();
			glTranslate(s0 * FACET_LENGTH, -s2 * FACET_LENGTH, 0);
			drawOctaFacet(mi, -1, -1, -1, -1, -1, 4, 8, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 1 || fd.face == 2) && fd.depth == size - 1)
				|| (use && (fd.face == 0 || fd.face == 3) && fd.depth == size - 3)
				|| (!use && (fd.face == 1 || fd.face == 2) && fd.depth != size - 1)
				|| (!use && (fd.face == 0 || fd.face == 3) && fd.depth != size - 3)))
			|| (sticky && ((use && (fd.face == 1 || fd.face == 2) && fd.depth == size - 1)
				|| (use && (fd.face == 0 || fd.face == 3) && (fd.depth == 1 || fd.depth == 2))
			...
			glPushMatrix();
			glTranslate(0, -s2 * FACET_LENGTH, -s0 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, -1, -1, -1, -1, 4, 8);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && (fd.face == 0 || fd.face == 1) && fd.depth == size - 1)
				|| (use && (fd.face == 2 || fd.face == 3) && fd.depth == size - 3)
				|| (!use && (fd.face == 0 || fd.face == 1) && fd.depth != size - 1)
				|| (!use && (fd.face == 2 || fd.face == 3) && fd.depth != size - 3)))
			|| (sticky && ((use && (fd.face == 0 || fd.face == 1) && fd.depth == size - 1)
				|| (use && (fd.face == 2 || fd.face == 3) && (fd.depth == 1 || fd.depth == 2))
			...
			glPushMatrix();
			glTranslate(-s0 * FACET_LENGTH, -s2 * FACET_LENGTH, 0);
			drawOctaFacet(mi, -1, -1, -1, -1, 8, -1, -1, 4);
			glPopMatrix();
		}
		...
		if (all || (!sticky && ((use && fd.face == 0 && fd.depth == 0)
			...
			drawOctaFacet(mi, 11, -1, -1, -1, -1, -1, 13, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && fd.face == 1 && fd.depth == 0)
				|| (use && fd.face == 3 && fd.depth == size - 1)
				|| (use && fd.face == 2 && fd.depth == 1)
				|| (use && fd.face == 0 && fd.depth == 2)
				|| (!use && fd.face == 1 && fd.depth != 0)
				|| (!use && fd.face == 3 && fd.depth != size - 1)
				|| (!use && fd.face == 2 && fd.depth != 1)
				|| (!use && fd.face == 0 && fd.depth != 2)))
			...
			drawOctaFacet(mi, -1, 11, -1, -1, -1, 13, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && fd.face == 2 && fd.depth == 0)
				|| (use && fd.face == 0 && fd.depth == size - 1)
				|| (use && fd.face == 3 && fd.depth == 1)
				|| (use && fd.face == 1 && fd.depth == 2)
				|| (!use && fd.face == 2 && fd.depth != 0)
				|| (!use && fd.face == 0 && fd.depth != size - 1)
				|| (!use && fd.face == 3 && fd.depth != 1)
				|| (!use && fd.face == 1 && fd.depth != 2)))
			...
			glPushMatrix();
			glTranslate(-s0 * FACET_LENGTH, 0, s2 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, 11, -1, 13, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && fd.face == 3 && fd.depth == 0)
				|| (use && fd.face == 1 && fd.depth == size - 1)
				|| (use && fd.face == 0 && fd.depth == 1)
				|| (use && fd.face == 2 && fd.depth == 2)
				|| (!use && fd.face == 3 && fd.depth != 0)
				|| (!use && fd.face == 1 && fd.depth != size - 1)
				|| (!use && fd.face == 0 && fd.depth != 1)
				|| (!use && fd.face == 2 && fd.depth != 2)))
			...
			glPushMatrix();
			glTranslate(-s2 * FACET_LENGTH, 0, -s0 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, -1, 11, -1, -1, -1, 13);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && fd.face == 2 && fd.depth == 0)
				|| (use && fd.face == 0 && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(-s2 * FACET_LENGTH, 0, s0 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, 13, -1, 11, -1, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && fd.face == 1 && fd.depth == 0)
				|| (use && fd.face == 3 && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(s0 * FACET_LENGTH, 0, s2 * FACET_LENGTH);
			drawOctaFacet(mi, -1, 13, -1, -1, -1, 11, -1, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && fd.face == 0 && fd.depth == 0)
				|| (use && fd.face == 2 && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(s2 * FACET_LENGTH, 0, -s0 * FACET_LENGTH);
			drawOctaFacet(mi, 13, -1, -1, -1, -1, -1, 11, -1);
			glPopMatrix();
		}
		if (all || (!sticky && ((use && fd.face == 3 && fd.depth == 0)
				|| (use && fd.face == 1 && fd.depth == size - 1)
			...
			glPushMatrix();
			glTranslate(-s0 * FACET_LENGTH, 0, -s2 * FACET_LENGTH);
			drawOctaFacet(mi, -1, -1, -1, 13, -1, -1, -1, 11);
			glPopMatrix();
		}
	}
}
		...
		Bool use, Bool all)
{
	...
	if (size > 1) { /* CORNERS */
		...
		if (all || (!sticky && ((use && cd.corner == 0 && cd.depth == e) 
				|| (use && cd.corner != 0 && cd.depth == size - 1)
		...
		if (all || (!sticky && ((use && cd.corner == 1 && cd.depth == e)
				|| (use && cd.corner != 1 && cd.depth == size - 1)
		...
		if (all || (!sticky && ((use && cd.corner == 2 && cd.depth == e)
				|| (use && cd.corner != 2 && cd.depth == size - 1)
