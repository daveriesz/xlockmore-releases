 ...
 * 04-Sep-1995: Written by Heath A. Kehoe <hakehoe AT icaen.uiowa.edu>.
 *
 */
...
extern GC GCCreate();
extern void xlockmore_set_mode_options(ModeSpecOpt *ms);
extern void XGetGCValues(Display *display, GC gc, unsigned long valuemask,
