...
# define DEF_INVALIDCAPSLOCK	"Mot de passe Invalide, Caps Lock on."
# define DEF_INFO	"Entrez le mot de passe ou choisissez l'icone pour verrouiller."
# define DEF_COUNT_FAILED	" essais échoué."
# define DEF_COUNTS_FAILED	" essais échoués."
#else
#if defined NL
...
{(caddr_t *) & planfontname, (char *) "planfont", (char *) "PlanFont", (char *) DEF_PLANFONT, t_String},
...
#ifdef HAVE_KRB5
	{(caddr_t *) & text_krbinfo, (char *) "kerberosinfo", (char *) "KerberosInfo", (char *) DEF_KRBINFO, t_String},
#endif /* HAVE_KRB5 */
   ...
   {(caddr_t *) & text_invalidCapsLock, (char *) "invalidCapsLock", (char *) "InvalidCapsLock", (char *) DEF_INVALIDCAPSLOCK, t_String},
   {(caddr_t *) & failed_attempt, (char *) "attempt", (char *) "Attempt", (char *) DEF_COUNT_FAILED, t_String},
   {(caddr_t *) & failed_attempts, (char *) "attempts", (char *) "Attempts", (char *) DEF_COUNTS_FAILED, t_String},
	...
	{(char *) "-verbose", (char *) "-bitmap", (char *) "-messagefont",
	 ...
	 (char *) "-trackmouse", (char *) "-cycle", (char *) "-cycle"};
			...
			for (j = 0; j < (int) ((sizeof current_args) / sizeof (*current_args)); j++)
				if (!strcmp(argv[i], depreciated_args[j])) {
