...
DrawRhombicDodecahedron(ModeInfo * mi, antstruct * cell)
{
	...
	*/
	if (ap->wireframe) {
		if (dx <= LEN) {
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 2, 5, 0, 3);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 13, 4, 0, 6);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 3, 0, 4, 1);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 5, 12, 6, 0);
		} else if (dx >= -LEN) {
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 2, 9, 12, 5);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 1, 8, 11, 7);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 7, 1, 8, 11);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 9, 11, 10, 12);
		}
		if (dy <= LEN) {
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 3, 0, 4, 1);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 7, 1, 8, 11);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 2, 3, 1, 7);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 13, 8, 1, 4);
		} else if (dy >= -LEN) {
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 5, 12, 6, 0);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 9, 11, 10, 12);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 2, 9, 12, 5);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 13, 6, 12, 10);
		}
		if (dz <= LEN) {
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 2, 3, 1, 7);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 2, 9, 12, 5);
		...
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 13, 6, 12, 10);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 13, 4, 0, 6);
		DrawFace(mi, -1, (int) (color & mask), cell, pts, 13, 10, 11, 8);
		}
	}
	sortx = sorty = sortz = 0;
	...
	for (i = 0; i < 3; i++) {
	  if (sortx == i) {
	    if (dx > LEN) {
	      if (sortz > sorty) {
		if (dz < 0)
		  DrawFace(mi, ZPXP, (int) (color & mask), cell, pts, 2, 5, 0, 3);
		else
		  DrawFace(mi, ZNXP, (int) (color & mask), cell, pts, 13, 4, 0, 6);
		DrawFace(mi, XPYN, (int) (color & mask), cell, pts, 5, 12, 6, 0);
		DrawFace(mi, XPYP, (int) (color & mask), cell, pts, 3, 0, 4, 1);
		if (dz < 0)
		  DrawFace(mi, ZNXP, (int) (color & mask), cell, pts, 13, 4, 0, 6);
		else
		  DrawFace(mi, ZPXP, (int) (color & mask), cell, pts, 2, 5, 0, 3);
		...
		if (dz < 0)
		  ...
		  DrawFace(mi, ZNXN, (int) (color & mask), cell, pts, 13, 10, 11, 8);
		DrawFace(mi, XNYN, (int) (color & mask), cell, pts, 9, 11, 10, 12);
		DrawFace(mi, XNYP, (int) (color & mask), cell, pts, 7, 1, 8, 11);
		if (dz < 0)
		  DrawFace(mi, ZNXN, (int) (color & mask), cell, pts, 13, 10, 11, 8);
		else
		  DrawFace(mi, ZPXN, (int) (color & mask), cell, pts, 2, 7, 11, 9);
	  ...
	  if (sorty == i) {
		...
		if (dx < 0)
		  ...
		  DrawFace(mi, XNYP, (int) (color & mask), cell, pts, 7, 1, 8, 11);
		DrawFace(mi, YPZN, (int) (color & mask), cell, pts, 13, 8, 1, 4);
		DrawFace(mi, YPZP, (int) (color & mask), cell, pts, 2, 3, 1, 7);
		if (dx < 0)
		  DrawFace(mi, XNYP, (int) (color & mask), cell, pts, 7, 1, 8, 11);
		else
		  DrawFace(mi, XPYP, (int) (color & mask), cell, pts, 3, 0, 4, 1);
		...
		if (dx < 0)
		  ...
		  DrawFace(mi, XNYN, (int) (color & mask), cell, pts, 9, 11, 10, 12);
		DrawFace(mi, YNZN, (int) (color & mask), cell, pts, 13, 6, 12, 10);
		...
		if (dz < 0)
		  ...
		  DrawFace(mi, YNZP, (int) (color & mask), cell, pts, 13, 6, 12, 10);
		DrawFace(mi, XNYN, (int) (color & mask), cell, pts, 9, 11, 10, 12);
		DrawFace(mi, XPYN, (int) (color & mask), cell, pts, 5, 12, 6, 0);
		if (dz < 0)
		  DrawFace(mi, YNZN, (int) (color & mask), cell, pts, 13, 6, 12, 10);
	  ...
	  if (sortz == i) {
		...
		if (dy < 0)
		  ...
		  DrawFace(mi, YNZN, (int) (color & mask), cell, pts, 13, 6, 12, 10);
		DrawFace(mi, ZNXN, (int) (color & mask), cell, pts, 13, 10, 1, 8);
		DrawFace(mi, ZNXP, (int) (color & mask), cell, pts, 13, 4, 0, 6);
		if (dy < 0)
		  DrawFace(mi, YNZN, (int) (color & mask), cell, pts, 13, 6, 12, 10);
		else
		...
		if (dx < 0)
		  ...
		  DrawFace(mi, ZNXP, (int) (color & mask), cell, pts, 13, 10, 1, 8);
		DrawFace(mi, YNZN, (int) (color & mask), cell, pts, 13, 6, 12, 10);
		DrawFace(mi, YPZN, (int) (color & mask), cell, pts, 13, 8, 1, 4);
		if (dx < 0)
		  DrawFace(mi, ZNXN, (int) (color & mask), cell, pts, 13, 10, 1, 8);
