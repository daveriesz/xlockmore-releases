 ...
 *
 * Revision History:
 * 28-Nov-2001: backported from xscreensaver-3.34 by lassauge@mail.dotcom.fr
 * 22-Feb-2001: backported from xscreensaver-3.33 by lassauge@mail.dotcom.fr
...
static argtype vars[] = {
  {(caddr_t *) &planetary, (char *) "planetary", (char *) "Planetary", (char *) DEF_PLANETARY, t_Bool},
