...
GetPattern(ModeInfo * mi, int pattern_rule, int pattern)
{
	...
	if (filePattern) {
		...
		case 14:
			...
			case LIFE_14S56B45:
				patptr = &patterns_14S56B45[pat][0];
#ifdef LIFE_NAMES
				patstrg = &patterns_14S56B45[2 * pattern][0];
#endif
			break;
		case 18:
			switch (pattern_rule) {
...
#define V2 (V/2)
	...
	if (!r) {
		...
		if (lp->neighbors == 12 && lp->patterned_rule == LIFE_12S3B3) {
			...
			populateGlider(lp, glider_26S38B5[1], 0,
				hsp, vsp, asp, hoff, voff, aoff);
		    }
		...
		if (lp->neighbors == 12 && lp->patterned_rule == LIFE_12S3B3) {
			...
			populateGlider(lp, glider_26S38B5[1], 1,
				hsp, vsp, asp, hoff, voff, aoff);
		    }
		} else if (lp->neighbors == 26 && lp->patterned_rule == LIFE_26S4B5) {
		...
		if (lp->neighbors == 12 && lp->patterned_rule == LIFE_12S3B3) {
			...
			populateGlider(lp, glider_26S38B5[1], 2,
				hsp, vsp, asp, hoff, voff, aoff);
		    }
		} else if (lp->neighbors == 26 && lp->patterned_rule == LIFE_26S4B5) {
