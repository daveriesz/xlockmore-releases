 ...
 *		Ron Hitchens <ron AT idiom.com>
 * 04-Sep-95: Moved over from mode.h (previously resource.h) with new
 *            "&*_opts" by Heath A. Kehoe <hakehoe AT icaen.uiowa.edu>.
 *
 */
...
LockStruct  LockProcs[] =
{
	...
	{(char *) "anemone", init_anemone, draw_anemone, release_anemone,
	 (ModeHook *)  NULL, init_anemone, free_anemone, &anemone_opts,
	...
	{(char *) "ball", init_ball, draw_ball, release_ball,
	 refresh_ball, init_ball, free_ball, &ball_opts,
	...
	{(char *) "blot", init_blot, draw_blot, release_blot,
	 refresh_blot, init_blot, free_blot, &blot_opts,
...
#endif
#ifdef MODE_boxed
	{(char *) "boxed", init_boxed, draw_boxed, release_boxed,
	draw_boxed, init_boxed, (ModeHook *) NULL, &boxed_opts,
	1000, 1, 2, 1, 64, 1.0, (char *) "",
	(char *) "Shows GL's boxed balls", 0, NULL},
#endif
#ifdef MODE_braid
	...
	{(char *) "juggler3d", init_juggler3d, draw_juggler3d, release_juggler3d,
	 draw_juggler3d, change_juggler3d, (ModeHook *) NULL, &juggler3d_opts,
	 10000, 200, 1000, 1, 64, 1.0, (char *) "",
	 (char *) "Shows a 3D Juggler, juggling", 0, NULL},
#endif
#ifdef MODE_julia
...
#endif
#ifdef MODE_maze3d
	{(char *) "maze3d", init_maze3d, draw_maze3d, release_maze3d,
	 draw_maze3d, init_maze3d, (ModeHook *) NULL, &maze3d_opts,
	 20000, 1, 2, 1, 64, 1.0, (char *) "",
	 (char *) "Shows a 3D maze", 0, NULL},
#endif
#ifdef MODE_mball
	{(char *) "mball", init_mball, draw_mball, release_mball,
	 draw_mball, change_mball, (ModeHook *) NULL, &mball_opts,
	 100000, -30, 5, -6, 64, 1.0, (char *) "",
	 (char *) "Shows an auto-solving Masterball puzzle", 0, NULL},
#endif
#ifdef MODE_moebius
	{(char *) "moebius", init_moebius, draw_moebius, release_moebius,
	 draw_moebius, change_moebius, (ModeHook *) NULL, &moebius_opts,
	 15000, 1, 1, 1, 64, 1.0, (char *) "",
...
#endif
#ifdef MODE_oct
	{(char *) "oct", init_oct, draw_oct, release_oct,
	 draw_oct, change_oct, (ModeHook *) NULL, &oct_opts,
	 100000, -30, 5, -6, 64, 1.0, (char *) "",
	 (char *) "Shows an auto-solving octahedron puzzle", 0, NULL},
#endif
#ifdef MODE_pacman
...
#endif
#ifdef MODE_paterson
	{(char *) "paterson", init_paterson, draw_paterson, release_paterson,
	 init_paterson, init_paterson, (ModeHook *) NULL, &paterson_opts,
	 50000, -3, 2000, -24, 64, 1.0, (char *) "",
	 (char *) "Shows Paterson's Worm Paths", 0, NULL},
#endif
#ifdef MODE_penrose
...
#endif
#ifdef MODE_pyro2
	{(char *) "pyro2", init_pyro2, draw_pyro2, release_pyro2,
	refresh_pyro2, init_pyro2, (ModeHook *) NULL, &pyro2_opts,
	15000, 100, 1, -3, 64, 1.0, (char *) "",
	(char *) "Shows other fireworks", 0, NULL},
#endif
#ifdef MODE_qix
...
#endif
#ifdef MODE_rain
	{(char *) "rain", init_rain, draw_rain, release_rain,
	 refresh_rain, init_rain, (ModeHook *) NULL, &rain_opts,
	 35000, 1, 1, 1, 64, 0.3, (char *) "",
	 (char *) "It's raining", 0, NULL},
#endif
#ifdef MODE_roll
...
#endif
#ifdef MODE_solitaire
	{(char *) "solitaire", init_solitaire, draw_solitaire, release_solitaire,
	 refresh_solitaire, init_solitaire, (ModeHook *) NULL, &solitaire_opts,
	 2000000, 1, 1, 1, 64, 1.0, (char *) "",
	 (char *) "Shows Klondike's game of solitaire", 0, NULL},
#endif
#ifdef MODE_space
	...
	{(char *) "spirolateral", init_spirolateral, draw_spirolateral, release_spirolateral,
	 refresh_spirolateral, init_spirolateral, (ModeHook *) NULL, &spirolateral_opts,
	 40000, -16, -32, 1, 64, 1.0, (char *) "",
	 (char *) "Shows Odds' Spirolaterals", 0, NULL},
#endif
#ifdef MODE_spline
...
/* SPECIAL MODES */
	...
	{(char *) "random", init_random, draw_random, release_random,
	 ...
	 1, 1, 1, 1, 64, 1.0, (char *) "",
#ifdef MODE_bomb
	 (char *) "Shows a random mode (except blank and bomb)",
#else
	 (char *) "Shows a random mode (except blank)",
#endif
	0, NULL},
};
...
call_release_hook(LockStruct * ls, ModeInfo * mi)
{
	...
	if (ls->free_hook != NULL) {
		int old_screen = MI_SCREEN(mi);
		for (MI_SCREEN(mi) = 0; MI_SCREEN(mi) != MI_NUM_SCREENS(mi); ++MI_SCREEN(mi))
			ls->free_hook (mi);
		MI_SCREEN(mi) = old_screen;
	}
	...
	if (ls->state_array) { /* MI_INIT modes only. */
		free(*ls->state_array);
		*ls->state_array = NULL;
		ls->state_array = NULL;

#ifdef USE_GL
		FreeAllGL(mi); /* Should be a safe no-op for Xlib modes. */
#endif
	}
...
void
mi_init(ModeInfo *mi, size_t state_size, void **state_array)
{
	LockStruct *ls = MI_LOCKSTRUCT(mi);
	ls->state_array = state_array;

	if (!*state_array) {
		*state_array = calloc (MI_NUM_SCREENS(mi), state_size);
	...
	if (ls->free_hook)
		ls->free_hook (mi);
	memset ((char *)(*ls->state_array) + MI_SCREEN(mi) * state_size, 0, state_size);
}
