...
typedef struct LockStruct_s {
	...
	void       **state_array;	/* array of per-screen state, set from MI_INIT */
} LockStruct;
...
typedef struct {
	...
	int         npixels;	/* number of valid entries in pixels */
        int         polygon_count; /* screensaver variable */
...
#define MI_POLYGONCOUNT(mi)	((mi)->screeninfo->polygon_count)
...
extern ModeHook free_apollonian;
...
#ifdef MODE_boxed
extern ModeHook init_boxed;
extern ModeHook draw_boxed;
extern ModeHook release_boxed;
extern ModeSpecOpt boxed_opts;
#endif
...
extern ModeHook init_juggler3d;
extern ModeHook draw_juggler3d;
extern ModeHook release_juggler3d;
extern ModeHook change_juggler3d;
extern ModeSpecOpt juggler3d_opts;
#endif
...
#ifdef MODE_maze3d
extern ModeHook init_maze3d;
extern ModeHook draw_maze3d;
extern ModeHook release_maze3d;
extern ModeSpecOpt maze3d_opts;
#endif

#ifdef MODE_mball
extern ModeHook init_mball;
extern ModeHook draw_mball;
extern ModeHook release_mball;
extern ModeHook change_mball;
extern ModeSpecOpt mball_opts;
#endif
...
#ifdef MODE_oct
extern ModeHook init_oct;
extern ModeHook draw_oct;
extern ModeHook release_oct;
extern ModeHook change_oct;
extern ModeSpecOpt oct_opts;
#endif
...
#ifdef MODE_paterson
extern ModeHook init_paterson;
extern ModeHook draw_paterson;
extern ModeHook release_paterson;
extern ModeSpecOpt paterson_opts;
#endif
...
#ifdef MODE_pyro2
extern ModeHook init_pyro2;
extern ModeHook draw_pyro2;
extern ModeHook release_pyro2;
extern ModeHook refresh_pyro2;
extern ModeSpecOpt pyro2_opts;
#endif
...
#ifdef MODE_rain
extern ModeHook init_rain;
extern ModeHook draw_rain;
extern ModeHook release_rain;
extern ModeHook refresh_rain;
extern ModeSpecOpt rain_opts;
#endif
...
extern ModeHook init_solitaire;
extern ModeHook draw_solitaire;
extern ModeHook release_solitaire;
extern ModeHook refresh_solitaire;
extern ModeSpecOpt solitaire_opts;
#endif
...
extern ModeHook init_spirolateral;
extern ModeHook draw_spirolateral;
extern ModeHook release_spirolateral;
extern ModeHook refresh_spirolateral;
extern ModeSpecOpt spirolateral_opts;
#endif
...
#define MI_INIT(mi, state_array) \
  { \
    mi_init ((mi), sizeof(*(state_array)), (void **)&(state_array)); \
    if (!state_array) \
      return; \
  }
extern void mi_init (ModeInfo *, size_t, void **);
