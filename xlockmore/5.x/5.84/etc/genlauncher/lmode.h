...
LockStruct  LockProcs[] =
{
	...
	{"mball",
	 ...
	 "Shows an auto-solving Masterball puzzle", 0, NULL, "#ifdef USE_GL"},
	{"moebius",
	 30000, 1, 1, 1, 64, 1.0, "",
	...
	{"oct",
	 100000, -30, 5, -6, 64, 1.0, "",
	 "Shows an auto-solving octahedron puzzle", 0, NULL, "#ifdef USE_GL"},
#endif
	{"pacman",
	 10000, 10, 1, 0, 64, 1.0, "",
	...
	{"paterson",
	 ...
	 "Shows Paterson's Worm Paths", 0, NULL, NULL},
	{"penrose",
	 10000, 1, 1, -40, 64, 1.0, "",
	...
	{"pyro2",
	 15000, 1, 1, 1, 64, 1.0, "",
	 "Shows other fireworks", 0, NULL, NULL},
	{"qix",
	 30000, -5, 32, 1, 64, 1.0, "",
	 "Shows spinning lines a la Qix(tm)", 0, NULL, NULL},
	{"rain",
	 35000, 1, 1, 1, 64, 0.3, "",
	 "Shows rain", 0, NULL, NULL},
	{"roll",
	...
	{"skewb",
	 100000, -30, 5, 1, 64, 1.0, "",
	 "Shows an auto-solving Skewb", 0, NULL, "#ifdef USE_GL"},
#endif
	{"slip",
	...
	{"solitaire",
	 ...
	 "Shows Klondike's game of solitaire", 0, NULL, "#ifdef HAVE_CXX"},
#endif
	{"space",
	 10000, 100, 1, 15, 64, 1.0, "",
	...
	{"spirolateral",
	 8000, -12, -19, 1, 64, 1.0, "",
	 "Shows Odds' Spirolaterals", 0, NULL, NULL},
	{"spline",
