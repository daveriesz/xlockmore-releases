...
$ freetypef="SYS$SHARE:FREETYPE2SHR.EXE"
$ ftglf="SYS$LIBRARY:LIBFTGL.OLB"
$ pngf="SYS$LIBRARY:LIBPNG.OLB"
...
$ if x86
$ then
$   xl_cxx=="cxx/name=(as_is,short)/point=32/warn=disable=(""c++11-extensions"")/assume=(nostdnew,noglobal_array_new"
$ else
...
$ if pnglib then defs=="''defs',HAVE_LIBPNG"
$ if ftgl .and. zlib
$ then
$   defs=="''defs',HAVE_FTGL"
$   if f$search("FTGL:ftgl.h") .nes. "" then defs=="''defs',FTGL213"
$ endif
$ if use_magick then defs=="''defs',USE_MAGICK"
$ if complmap then defs=="''defs',COMPLIANT_COLORMAP"
$ if xpm then defs=="''defs',HAVE_XPM"
$ if gl .or. gl_share then defs=="''defs',USE_GL,HAVE_GLBINDTEXTURE,MESA,SLOW"
...
$ defsxm = "HAVE_MOTIF,''defs'"
$ defsxa = "HAVE_LIB_XAW3D,''defs'"
$ if sys_maj .ge. 7
$ then
$   defs=="''defs',HAVE_USLEEP"
$   defsxm=="''defsxm',HAVE_USLEEP"
$   defsxa=="''defsxa',HAVE_USLEEP"
$! The next must be the last one.
$   defs=="''defs',""""SRAND=srand48"""",""""LRAND=lrand48"""",MAXRAND=2147483648.0"
$   defsxm=="''defsxm',""""SRAND=srand48"""",""""LRAND=lrand48"""",MAXRAND=2147483648.0"
$   defsxa=="''defsxa',""""SRAND=srand48"""",""""LRAND=lrand48"""",MAXRAND=2147483648.0"
$ endif
$!
...
$ if x86
$ then
$   xl_cxx=="cxx/name=(as_is,short)/point=32/warn=disable=(""c++11-extensions"")/assume=(nostdnew,noglobal_array_new)/include=([],[.xlock])/define=(''defs')"
$ else
$   xl_cxx=="cxx/name=(as_is,short)/float=ieee/assume=(nostdnew,noglobal_array_new)/include=([],[.xlock])/define=(''defs')"
$ endif
$ if deccxx
...
$   if x86
$   then
$     xl_cc=="cxx/name=(as_is,short)/point=32/warn=disable=(""c++11-extensions"")/assume=(nostdnew,noglobal_array_new)/include=([],[.xlock])/define=(''defs')"
$   else
...
$     if x86
$     then
$       xl_cc=="cxx/name=(as_is,short)/point=32/warn=disable=(""c++11-extensions"")/assume=(nostdnew,noglobal_array_new)/deb/noopt/include=([],[.xlock])/define=(''defs')/list"
$     else
...
$       xl_cc=="cc/name=(as_is,short)/point=32/deb/noopt/include=([],[.xlock])/define=(''defs')/list"
$     else
$       if decc
$       then
...
$   if x86
$   then
$     if iscxx then xl_link=="link/trace"
$   else
...
$ call make pyro2.xbm  "set file/enter=[]pyro2.xbm [.bitmaps]l-dec.xbm"  [.bitmaps]l-dec.xbm
$ if xpm
$ then
...
$   call make decay.xpm  "set file/enter=[]decay.xpm [.pixmaps]l-dec.xpm" [.pixmaps]l-dec.xpm
...
$   call make maze.xpm  "set file/enter=[]maze.xpm [.pixmaps]l-dec.xpm"    [.pixmaps]l-dec.xpm
$   call make puzzle.xpm "set file/enter=[]puzzle.xpm [.pixmaps]l-xlock.xpm" [.pixmaps]l-xlock.xpm
$   call make pyro2.xpm  "set file/enter=[]pyro2.xpm [.pixmaps]l-dec.xpm"  [.pixmaps]l-dec.xpm
$ endif
$!
...
$ if use_magick
$ then
$   call make [.xlock]magick.obj    "xl_cc /object=[.xlock] [.xlock]magick.c"      [.xlock]magick.c [.xlock]xlock.h [.xlock]magick.h [.xlock]xlockimage.c magick:MagickCore.h
$   call make [.xlock]iostuff.obj  "xl_cc /object=[.xlock] [.xlock]iostuff.c"  [.xlock]iostuff.c [.xlock]xlock.h [.xlock]iostuff.h [.xlock]magick.h magick:MagickCore.h
$ else
...
$ call make [.xlock]thread_util.obj    "xl_cc /object=[.xlock] [.xlock]thread_util.c"    [.xlock]thread_util.c [.xlock]thread_util.h [.xlock]aligned_malloc.h
$ call make [.xlock]aligned_malloc.obj "xl_cc /object=[.xlock] [.xlock]aligned_malloc.c" [.xlock]aligned_malloc.c [.xlock]aligned_malloc.h
$ if check
$ then
...
$ call make [.modes]paterson.obj  "xl_cc /object=[.modes] [.modes]paterson.c"  [.modes]paterson.c [.xlock]xlock.h [.xlock]mode.h
...
$ call make [.modes]pyro2.obj    "xl_cc /object=[.modes] [.modes]pyro2.c"    [.modes]pyro2.c [.xlock]xlock.h [.xlock]mode.h
$ call make [.modes]qix.obj      "xl_cc /object=[.modes] [.modes]qix.c"      [.modes]qix.c [.xlock]xlock.h [.xlock]mode.h
$ call make [.modes]rain.obj      "xl_cc /object=[.modes] [.modes]rain.c"      [.modes]rain.c [.xlock]xlock.h [.xlock]mode.h
...
$ call make [.modes]spirolateral.obj    "xl_cc /object=[.modes] [.modes]spirolateral.c"    [.modes]spirolateral.c [.xlock]xlock.h [.xlock]mode.h
...
$ if iscxx
$ then
$   call make [.modes]solitaire.obj    "xl_cxx /object=[.modes] [.modes]solitaire.cc"    [.modes]solitaire.cc [.xlock]xlock.h [.xlock]mode.h
$ endif
$ if gl .or. gl_share
$ then
$   call make [.modes.glx]bevel.obj      "xl_cc /object=[.modes.glx] [.modes.glx]bevel.c"    [.modes.glx]bevel.c [.xlock]xlock.h [.xlock]mode.h
$   call make [.modes.glx]boxed.obj      "xl_cc /object=[.modes.glx] [.modes.glx]boxed.c"      [.modes.glx]boxed.c [.modes.glx]boxed.h [.xlock]xlock.h [.xlock]mode.h
$   call make [.modes.glx]cage.obj      "xl_cc /object=[.modes.glx] [.modes.glx]cage.c"      [.modes.glx]cage.c [.xlock]xlock.h [.xlock]mode.h
$   call make [.modes.glx]dino.obj      "xl_cc /object=[.modes.glx] [.modes.glx]dino.c"    [.modes.glx]dino.c [.xlock]xlock.h [.xlock]mode.h
...
$   call make [.modes.glx]mball.obj    "xl_cc /object=[.modes.glx] [.modes.glx]mball.c"    [.modes.glx]mball.c [.xlock]xlock.h [.xlock]mode.h
...
$   call make [.modes.glx]oct.obj    "xl_cc /object=[.modes.glx] [.modes.glx]oct.c"    [.modes.glx]oct.c [.xlock]xlock.h [.xlock]mode.h
...
$   call make [.modes.glx]juggler3d.obj "xl_cc /object=[.modes.glx] [.modes.glx]juggler3d.c" [.modes.glx]juggler3d.c [.xlock]xlock.h [.xlock]mode.h
...
$   call make [.modes.glx]gltrackball.obj  "xl_cc /object=[.modes.glx] [.modes.glx]gltrackball.c"  [.modes.glx]gltrackball.c [.xlock]xlock.h [.xlock]mode.h
$   call make [.modes.glx]trackball.obj "xl_cc /object=[.modes.glx] [.modes.glx]trackball.c" [.modes.glx]trackball.c [.xlock]xlock.h [.xlock]mode.h
$   call make [.modes.glx]glxfonts.obj  "xl_cc /object=[.modes.glx] [.modes.glx]glxfonts.c"  [.modes.glx]glxfonts.c [.xlock]xlock.h [.xlock]mode.h
$   if pnglib .and. use_bin2c .and. use_gsed
$   then
$     call make [.modes.glx]bob_png.h_ "bin2c [.png]bob.png [.modes.glx]bob_png.h_ bob_png" [.png]bob_png
$     call make [.modes.glx]bob_png.h "pipe gsed -e ""s/const char/static const unsigned char/"" < [.modes.glx]bob_png.h_ > [.modes.glx]bob_png.h" [.modes.glx]bob_png.h_
$     call make [.modes.glx]brick1_png.h_ "bin2c [.png]brick1.png [.modes.glx]brick1_png.h_ brick1_png" [.png]brick1.png
$     call make [.modes.glx]brick1_png.h "pipe gsed -e ""s/const char/static const unsigned char/"" < [.modes.glx]brick1_png.h_ > [.modes.glx]brick1_png.h" [.modes.glx]brick1_png.h_
$     call make [.modes.glx]brick2_png.h_ "bin2c [.png]brick2.png [.modes.glx]brick2_png.h_ brick2_png" [.png]brick2.png
$     call make [.modes.glx]brick2_png.h "pipe gsed -e ""s/const char/static const unsigned char/"" < [.modes.glx]brick2_png.h_ > [.modes.glx]brick2_png.h" [.modes.glx]brick2_png.h_
$     call make [.modes.glx]logo-32_png.h_ "bin2c [.png]logo_vms.png [.modes.glx]logo-32_png.h_ logo_32_png" [.png]logo_vms.png
$     call make [.modes.glx]logo-32_png.h "pipe gsed -e ""s/const char/static const unsigned char/"" < [.modes.glx]logo-32_png.h_ > [.modes.glx]logo-32_png.h" [.modes.glx]logo-32_png.h_
$     call make [.modes.glx]start_png.h_ " bin2c [.png]start_vms.png [.modes.glx]start_png.h_ start_png" [.png]start_vms.png
$     call make [.modes.glx]start_png.h "pipe gsed -e ""s/const char/static const unsigned char/"" < [.modes.glx]start_png.h_ > [.modes.glx]start_png.h" [.modes.glx]start_png.h_
$     call make [.modes.glx]wood2_png.h_ "bin2c [.png]wood2.png [.modes.glx]wood2_png.h_ wood2_png" [.png]wood2.png
$     call make [.modes.glx]wood2_png.h "pipe gsed -e ""s/const char/static const unsigned char/"" < [.modes.glx]wood2_png.h_ > [.modes.glx]wood2_png.h" [.modes.glx]wood2_png.h_
$     call make [.modes.glx]maze3d.obj  "xl_cc /object=[.modes.glx] [.modes.glx]maze3d.c"  [.modes.glx]maze3d.c [.xlock]xlock.h [.xlock]mode.h
$     call make [.modes.glx]ximage-loader.obj  "xl_cc /object=[.modes.glx] [.modes.glx]ximage-loader.c"  [.modes.glx]ximage-loader.c [.xlock]xlock.h [.xlock]mode.h
$   endif
$   if iscxx
$   then
...
$ if pnglib then write optf "''pngf'/lib"
...
$ if ft then write optf "''freetypef'/share"
...
$!
$! Redefine C-compiler options
$ if axp .or. ia64 .or. x86
$ then
$   xl_cc=="cc/name=(as_is,short)/float=ieee/include=([],[.xlock])/define=(''defsxm')"
$ else
$   if decc
$   then
$!      xl_cc=="cc/decc/standard=vaxc/include=([],[.xlock])/define=(''defs')"
$     xl_cc=="cc/decc/include=([],[.xlock])/define=(''defsxm')"
$   else ! VAX C
$     xl_cc=="cc/include=([],[.xlock])/define=(''defsxm')"
$   endif
$ endif
$! Create .opt file
$ open/write optf xmlock.opt
$ write sys$output "Compiling XMLock ..."
$ call make [.xmlock]option.obj "xl_cc /warn=disable=BADPTRARITH /object=[.xmlock] [.xmlock]option.c" [.xmlock]option.c
$ call make [.xmlock]xmlock.obj "xl_cc /warn=disable=BADPTRARITH /object=[.xmlock] [.xmlock]xmlock.c" [.xmlock]xmlock.c
$! Get libraries
$ if .not. ia64 .and. .not. x86 then write optf "sys$library:vaxcrtl/lib"
$ if axp .or. ia64 .or. x86 then write optf "sys$library:ucx$ipc_shr/share"
$ if axp .or. ia64 .or. x86 then write optf "sys$share:decw$xextlibshr/share"
...
$!
$! xawlock
$ if use_xaw3d .and. use_gsed
$ then
$   open/write optf xawlock.opt
$ write sys$output "Compiling xawlock ..."
$   if axp .or. ia64 .or. x86
$   then
$     xl_cc=="cc/name=(as_is,short)/float=ieee/include=([],[.xlock])/define=(''defsxa')"
$   else
$     if decc
$     then
$!      xl_cc=="cc/decc/standard=vaxc/include=([],[.xlock])/define=(''defs')"
$       xl_cc=="cc/decc/include=([],[.xlock])/define=(''defsxa')"
$     else ! VAX C
$       xl_cc=="cc/include=([],[.xlock])/define=(''defsxa')"
$     endif
$   endif
$   pipe gsed -e "s/X11\/Xaw3d/Xaw3d/" < [.xmlock]option.c > [.xmlock]xaoption.c
$   call make [.xmlock]xaoption.obj "xl_cc /warn=disable=BADPTRARITH /object=[.xmlock] [.xmlock]xaoption.c" [.xmlock]xaoption.c
$   pipe gsed -e "s/X11\/Xaw3d/Xaw3d/" < [.xmlock]xmlock.c > [.xmlock]xawlock.c
$   call make [.xmlock]xawlock.obj "xl_cc /warn=disable=BADPTRARITH /object=[.xmlock] [.xmlock]xawlock.c" [.xmlock]xawlock.c
...
$   write optf "sys$share:decw$xlibshr/share"
$   close optf
$   write sys$output "Linking xawlock"
$   xl_link/map/exec=[.xmlock]xawlock.exe xawlock/opt
$ endif
$!
$ if mmov
$ then
