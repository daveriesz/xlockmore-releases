...
LockStruct  LockProcs[] =
{
	...
	{"mball",
	 100000, -30, 5, -6, 1.00,
	 "Shows an auto-solving Masterball puzzle", (void *) NULL},
#endif
#ifdef USE_GL
	{"moebius",
	 30000, 1, 1, 1, 1.00,
	...
	{"oct",
	 100000, -30, 5, -6, 1.00,
	 "Shows an auto-solving octahedron puzzle", (void *) NULL},
#endif
	{"pacman",
	 10000, 10, 1, 0, 1.00,
	 "Shows Pacman(tm)", (void *) NULL},
	{"paterson",
	 1000, -3, 40000, -12, 1.00,
	 "Shows Paterson's Worm Paths", (void *) NULL},
	{"penrose",
	 10000, 1, 1, -40, 1.00,
	...
	{"spirolateral",
	 8000, -12, -19, 1, 1.00,
	 "Shows Odds' Spirolaterals", (void *) NULL},
	{"spline",
	 30000, -6, 2048, 1, 0.30,
