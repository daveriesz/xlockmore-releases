...
static argtype vars[] = {
  {(caddr_t *) &molecule_str, (char *) "molecule",   (char *) "Molecule", (char *) DEF_MOLECULE,t_String},
#ifdef STANDALONE
  {(caddr_t *) &timeout,   (char *) "timeout",(char *) "Seconds", (char *) DEF_TIMEOUT,t_Int},
#endif
  {(caddr_t *) &do_spin,   (char *) "spin",   (char *) "Spin",   (char *) DEF_SPIN,   t_String},
  {(caddr_t *) &do_wander, (char *) "wander", (char *) "Wander", (char *) DEF_WANDER, t_Bool},
  {(caddr_t *) &do_labels, (char *) "labels", (char *) "Labels", (char *) DEF_LABELS, t_Bool},
  {(caddr_t *) &do_titles, (char *) "titles", (char *) "Titles", (char *) DEF_TITLES, t_Bool},
  {(caddr_t *) &do_atoms,  (char *) "atoms",  (char *) "Atoms",  (char *) DEF_ATOMS,  t_Bool},
  {(caddr_t *) &do_bonds,  (char *) "bonds",  (char *) "Bonds",  (char *) DEF_BONDS,  t_Bool},
  {(caddr_t *) &do_bbox,   (char *) "bbox",   (char *) "BBox",   (char *) DEF_BBOX,   t_Bool},
};
...
#ifdef STANDALONE
  load_font (mi, (char *) "atomFont",  &mc->xfont1, &mc->font1_dlist);
  load_font (mi, (char *) "titleFont", &mc->xfont2, &mc->font2_dlist);
#else
  load_font (mi, (char *) "-*-times-bold-r-normal-*-240-*",  &mc->xfont1, &mc->font1_dlist);
  load_font (mi, (char *) "-*-times-bold-r-normal-*-180-*", &mc->xfont2, &mc->font2_dlist);
#endif
}
