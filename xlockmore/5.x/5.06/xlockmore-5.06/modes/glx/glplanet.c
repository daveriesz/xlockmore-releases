...
static argtype vars[] = {
  {(caddr_t *) &do_rotate,   (char *) "rotate",  (char *) "Rotate",
    (char *) DEF_ROTATE,  t_Bool},
  {(caddr_t *) &do_roll,     (char *) "roll",    (char *) "Roll",
    (char *) DEF_ROLL,    t_Bool},
  {(caddr_t *) &do_bounce,   (char *) "bounce",  (char *) "Bounce",
    (char *) DEF_BOUNCE,  t_Bool},
  {(caddr_t *) &do_texture,  (char *) "texture", (char *) "Texture",
    (char *) DEF_TEXTURE, t_Bool},
  {(caddr_t *) &do_stars,    (char *) "stars",   (char *) "Stars",
    (char *) DEF_STARS,   t_Bool},
  {(caddr_t *) &do_light,    (char *) "light",   (char *) "Light",
    (char *) DEF_LIGHT,   t_Bool},
  {(caddr_t *) &which_image, (char *) "pimage",  (char *) "Pimage",
