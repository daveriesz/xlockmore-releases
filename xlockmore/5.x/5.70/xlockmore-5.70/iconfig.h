...
XCOMM #define DisablePosixThreads
...
XCOMM Only the solitaire.cc, invert.c, and text3d.cc modes use this.
...
XCOMM      *** BEGIN THREAD CONFIG SECTION ***
#if HasPosixThreads && !defined(DisablePosixThreads)
#include "Threads.tmpl"
THREADDEF = -DHAVE_PTHREADS
#endif
XCOMM      *** END THREAD CONFIG SECTION ***
...
$(XPMINC) $(GLINC) $(DTSAVERINC) $(DPMSINC) $(SOUNDINC) $(XLOCKINC)

EXTRA_LDOPTIONS += $(THREADS_LDFLAGS)
