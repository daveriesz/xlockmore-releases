...
LockStruct  LockProcs[] =
{
	...
	{(char *) "juggle", init_juggle, draw_juggle, release_juggle,
	 draw_juggle, init_juggle, (ModeHook *) NULL, &juggle_opts,
