...
void free_scooter(scooterstruct *sp)
{
	if (sp->doors != NULL) {
		(void) free((void *) sp->doors);
		sp->doors = (Door *) NULL;
	}
	if (sp->stars != NULL) {
		(void) free((void *) sp->stars);
		sp->stars = (Star *) NULL;
	}
	if (sp->zelements != NULL) {
		(void) free((void *) sp->zelements);
...
void release_scooter(ModeInfo *mi)
{
        if (scooters != NULL) {
                ...
                (void) free((void *) scooters);
                scooters = (scooterstruct *) NULL;
        }
	if (sintable != NULL) {
		(void) free((void *) sintable);
		sintable = (float *) NULL;
	}
}
