...
XCOMM SUNOS 4.1.3
XCOMM  DEF_PLAY = "/usr/demo/SOUND/play /usr/lib/X11/xlock/sounds/"
XCOMM IRIX 5.3
XCOMM  DEF_PLAY = "/usr/sbin/sfplay /usr/lib/X11/xlock/sounds/"
XCOMM Digital Unix with Multimedia Services installed:
XCOMM  DEF_PLAY = "/usr/bin/mme/decsound -play /usr/lib/X11/xlock/sounds/"
XCOMM LINUX and others (see config directory)
XCOMM  DEF_PLAY = "/usr/local/bin/play.sh /usr/lib/X11/xlock/sounds/"
...
EXTRA_LDOPTIONS = -R/usr/lib:/usr/openwin/lib:/usr/dt/lib:/usr/remote/lib
