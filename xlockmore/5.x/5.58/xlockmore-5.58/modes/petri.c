 ...
 * with help from Jamie Zawinski, jwz AT jwz.org
 ...
 *
 * Revision History:
 * 22 Jul-2002: xlockmore version by Jouk Jansen <joukj AT hrem.nano.tudelft.nl>
 */
...
typedef struct {
   ...
   cell *head;
   cell *tail;
   unsigned int count;  /* Must be unsigned due to shifting */
   Bool originalcolors;
   GC *coloredGCs;
   int blastcount;
   int windowWidth;
