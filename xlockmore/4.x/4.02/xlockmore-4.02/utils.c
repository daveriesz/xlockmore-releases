...
void
showVisualInfo(XVisualInfo *wantVis)
{
	(void) fprintf(stderr, "Visual info: ");
	(void) fprintf(stderr, "screen %d, ", wantVis->screen);
#if defined(__cplusplus) || defined(c_plusplus)
	(void) fprintf(stderr, "class %s, ", nameOfVisualClass(wantVis->c_class));
#else
	(void) fprintf(stderr, "class %s, ", nameOfVisualClass(wantVis->class));
#endif
