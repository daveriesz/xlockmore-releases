...
XCOMM /usr/include/dlfcn.h is no longer found there at least on 2.0.0
XCOMM Anybody have any ideas?  So I will try to get this running on
XCOMM Solaris-2.6 with gcc and gmake first.  I don't know if
XCOMM other Unices support this kind of dynamic loading.
...
$(XPMLIB) $(GLLIB) $(DTSAVERLIB) $(SOUNDLIB)
