...
#define WI_FLAG_JUST_INITTED	0x400	/* private state flag */
...
#ifdef USE_GL
extern ModeHook init_gear;
extern ModeHook draw_gear;
extern ModeHook release_gear;
extern ModeSpecOpt gear_opts;
