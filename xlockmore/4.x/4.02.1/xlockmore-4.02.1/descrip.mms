...
# Add sproingies mode if you like.  It may be slow but its really cool.
#SPROINGIEDEF = ,USE_SPROINGIES
#XLOCKSPROINGIEOBJS = sproingies$(O)$(S)sproingiewrap$(O)$(S)\
...
CFLAGS = /define = (VMS,USE_VROOT,USE_BOMB$(SOUNDDEF)$(XPMDEF)$(XVMSUTILSDEF)$(SPROINGIEDEF)$(HACKERDEF))$(SYSTEMDEF)
LDFLAGS =
...
$(XLOCKSPROINGIESRCS) $(XLOCKHACKERSSRCS)
