#ifndef lint
static char sccsid[] = "@(#)resource.c	2.10 95/06/17 xlockmore";
#endif
/*-
    ...
    char       *argv[];
{
    ...
    /*
     * if LRAND < mode, then just grab a random entry from the table
     */
    if (!strcmp(mode, "random"))
      mode = LockProcs[LRAND() % (NUMPROCS - NUMSPECIAL)].cmdline_arg;
