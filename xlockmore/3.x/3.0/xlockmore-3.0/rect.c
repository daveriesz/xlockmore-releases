#ifndef lint
static char sccsid[] = "@(#)rect.c	3.0 95/06/27 xlockmore";
#endif
/*-
...
#ifdef VMS 
#include <X11/bitmaps/stipple.xbm>
#include <X11/bitmaps/cross_weave.xbm>
#include <X11/bitmaps/dimple1.xbm>
#include <X11/bitmaps/dimple3.xbm>
#include <X11/bitmaps/flipped_gray.xbm>
#include <X11/bitmaps/gray1.xbm>
#include <X11/bitmaps/gray3.xbm>
#include <X11/bitmaps/hlines2.xbm>
#include <X11/bitmaps/light_gray.xbm>
#include <X11/bitmaps/root_weave.xbm>
#include <X11/bitmaps/vlines2.xbm>
#include <X11/bitmaps/vlines3.xbm>
#else
    ...
    Window      win;
{
  ...
  for (i = 0; i < 10; i++) /* minimize area, but don't try too hard */ {
    rp->w = 50 + LRAND() % (rp->width - 50);
    rp->h = 50 + LRAND() % (rp->height - 50);
